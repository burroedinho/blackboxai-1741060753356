...
# ==================== APIs GRATUITAS ====================
# Alpha Vantage (gratuito - 5 chamadas/min)
ALPHA_VANTAGE_KEY = os.getenv("ALPHA_VANTAGE_KEY", "demo")

# Yahoo Finance (gratuito - sem limite)
USE_YAHOO_FINANCE = True

# MetaTrader5 (gratuito - requer conta demo)
...
AUTO_EVOLUTION_ENABLED = True  # Habilita auto-evolução
REWRITE_CODE_ENABLED = True  # Habilita reescrita de código
MIN_ACCURACY_THRESHOLD = 0.65  # Acurácia mínima para operar

# ==================== SEGURANÇA ====================
ENCRYPTION_KEY = os.getenv("ENCRYPTION_KEY", "")
ENABLE_ENCRYPTION = False  # Habilitar criptografia de dados sensíveis
